...
- **Community Projects** — Collective efforts with task lists, starter templates, co-organizer invitations, task ordering and soft dependencies, and a page per task for its discussion thread. The **My work** tab (`/my-work`) gathers every task you're carrying and every project in your care, across projects.
