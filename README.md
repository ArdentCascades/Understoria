...
<!-- Ten languages: apps/web/src/i18n/languages.ts (LANGUAGES).
     Eight carry reviewStatus: "new". Guarded by
...
- **Documentation** — Guides, tutorials, and translation review. The app
  ships in ten languages; eight of them have not yet been read by a native
