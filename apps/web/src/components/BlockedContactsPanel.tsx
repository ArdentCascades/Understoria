...
export function BlockedContactsPanel() {
  ...
  return (
    ...
    >
      ...
      {/* Active blocks */}
      <h3 className="mt-3 mb-2 text-xs font-semibold uppercase tracking-wide text-moss-500">
      ...
      {/* Previously blocked */}
      <h3 className="mt-5 mb-2 text-xs font-semibold uppercase tracking-wide text-moss-500">
      ...
      {/* Cross-device fine print — design doc §14.1 gap named not
          papered over. */}
      <p className="mt-5 text-xs text-moss-500 dark:text-moss-400">
