...
function MonthChip({
  ...
  if (entry.kind === "event") {
    ...
    // For a multi-day span the visible chip text stays the bare title
    // (preserving the 3-chip cap + truncation); the day position is
    // carried only on the day-aware aria-label + title attribute.
    const isLastDay =
