...
// The Vietnamese content bundle — loaded lazily by content/registry.ts
// (its own `lazy-content-vi` chunk, excluded from the service-worker
...
export { PROJECT_TEMPLATES_VI as PROJECT_TEMPLATES } from "../projectTemplates.vi";
export { TASK_STEPS_VI as TASK_STEPS } from "../taskSteps.vi";
export { TASK_TIPS_VI as TASK_TIPS } from "../taskTips.vi";
