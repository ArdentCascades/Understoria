...
export const DESIGN_PRINCIPLES_ZH: readonly DesignPrinciple[] = [
  ...
  },
  {
    ...
    title: "默认安静",
    statement:
      "从不会有什么响起来把你拉回。你打开应用时，我们把需要你的事摆出来；通知只在你自己要了它时才存在，只用于另一头有人、或有钟表在走的事——而且一切出厂即关。",
    example:
      "COVID 疫情期间组织互助的人普遍讲到：靠通知驱动的工具，最先耗尽的是投入最深的成员——恰恰是社区最经不起失去的人。撑起这条原则的是这份经历，不是什么正式研究。后来有了自选提醒，这条原则是被修订、不是被废除：拉人回来的机制照旧禁止——变化只在于，自己要求为时段被叫醒的成员，现在可以被叫醒了。",
  },
  {
