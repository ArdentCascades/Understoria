...
describe("projectTemplates", () => {
  it("ships exactly 10 templates in English", () => {
    expect(PROJECT_TEMPLATES_EN.length).toBe(10);
  });

  it("ships exactly 10 templates in Spanish", () => {
    expect(PROJECT_TEMPLATES_ES.length).toBe(10);
  });
