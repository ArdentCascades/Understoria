...
| # | Agent | Status | Owns |
|---|-------|--------|------|
| 1 | Core PWA | shipped | Board, exchange flow, credits, dashboard, achievements, profile, PWA shell. Help-seeker UX improvements shipped (PRs #66–#67): repost with changes, expiry visibility chip, category descriptions in PostForm, exchange confirmation guidance, location-zone filtering on Board, "still looking" gentle prompt |
